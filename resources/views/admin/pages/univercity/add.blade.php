        ...
        <div class="col-md-12 col-sm-12">
            <div class="card card-box">
                <div class="card-body " id="bar-parent3">
                    <form action="{{ route('add-univercity') }}" id='addunivercityform' class="" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group ">
                            <label class="control-label" >Name</label>
                            <input type="text" class="form-control" name="name" placeholder="Enter Univercity Name">
                        </div>
                        <div class="form-group ">
...
<!--<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="card card-box">
            <div class="card-head">
                <header>Add Univercity</header>

            </div>
            <div class="card-body " id="bar-parent3">
                <form id='addunivercityform' class="" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group ">
